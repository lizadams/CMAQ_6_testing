...
# Completely clear all manual fabric and provider overrides
unsetenv I_MPI_FABRICS
unsetenv FI_PROVIDER
unsetenv I_MPI_OFI_PROVIDER
unsetenv FI_TCP_IFACE

# Use the fallback process manager interface built into Slurm
setenv I_MPI_PMI_LIBRARY libpmi2.so

# Keep CPU pinning alignment
setenv I_MPI_PIN 1
...
# ===================================================================
  ...
  ( srun --mpi=pmi2 $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
