...
#> Critical Folder Locations
 ...
 setenv CMAQ_HOME /proj/ie/proj/CMAS/CMASOps2026/CMAQ_CMAS_6/openmpi_5.0.9_gcc_15.2.0
...
#>  gfortran compiler............................................................
    case gcc:
        setenv BUILD /proj/ie/proj/CMAS/CMAQOps2026/CMAQ_CMAS_6/libraries/LIBRARIES_gcc
        # find path for openmpi libraries # ompi_info --path libdir
        # find path for include files for openmpi # ompi_info --path incdir
        setenv OPENMPI /nas/sycamore/apps/openmpi/5.0.9_gcc_15.2.0/
        ...
        setenv IOAPI_LIB_DIR    $BUILD/ioapi-3.2/Linux2_x86_64gfort15              #> I/O API libraries
        ...
        setenv MPI_INCL_DIR     $OPENMPI/include              #> MPI Include directory path
        setenv MPI_LIB_DIR      $OPENMPI/lib               #> MPI Lib directory path
        ...
        setenv myDBG  "-Wall -O0 -g -fcheck=all -ffpe-trap=overflow -fbacktrace"
        # added -std=legacy to myFFLAGS
...
if ( ! -e $NETCDFF_DIR/lib/libnetcdff.a ) then
 ...
 if ( ! -e $IOAPI_LIB_DIR/m3utilio.mod ) then 
    echo "ERROR: $IOAPI_LIB_DIR/m3utilio.mod does not exist in your CMAQ_LIB directory!!! Check your installation before proceeding with CMAQ build."
    exit
 endif
