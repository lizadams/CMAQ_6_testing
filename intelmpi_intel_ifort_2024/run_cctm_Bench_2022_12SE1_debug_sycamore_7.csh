...
# Clear out the legacy fabric flags that caused the crash
unsetenv I_MPI_FABRICS
unsetenv I_MPI_SHM

# Force Intel MPI to use Libfabric (OFI)
setenv I_MPI_FABRICS ofi

# Force the Libfabric provider specifically to Shared Memory (no network)
setenv FI_PROVIDER shm

# Clean up UCX variables to avoid collisions
setenv UCX_TLS ^ud
